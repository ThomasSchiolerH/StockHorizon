        ...
        <TableBody>
          {stocks.map((stock, index) => (
            <TableRow key={index} sx={{ '&:hover': { backgroundColor: '#333' }, height: '48px' }}>
              ...
              <TableCell sx={{ color: 'var(--theme-colour-text)', fontSize: '0.75em', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', padding: '4px 8px', width: '24%' }}>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  {stock.stockDetails.logo && (
                    <img src={stock.stockDetails.logo} alt={`${stock.stockDetails.name} logo`} style={{ marginRight: '10px', width: '20px', height: '20px', borderRadius: '50%' }} />
                  )}
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <span style={{ fontWeight: 'bold' }}>{stock.stockSymbol}</span>
                    <span style={{ color: '#cccccc', fontSize: '0.65em' }}>{stock.stockDetails.name}</span>
                  </div>
                </Box>
              </TableCell>
              <TableCell sx={{ color: '#cccccc', fontSize: '0.75em', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', padding: '4px 8px', width: '12%' }}>{stock.stockDetails.finnhubIndustry}</TableCell>
              ...
              <TableCell sx={{ color: '#cccccc', fontSize: '0.75em', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', padding: '4px 8px', width: '12%' }}>{stock.totalNewsCount}</TableCell>
...
//               <TableCell sx={{ color: '#bbb', fontSize: '0.75em', textTransform: 'uppercase', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', width: '12%', padding: '4px 8px', textAlign: 'left', fontWeight: 'bold' }}>Mentions</TableCell>
//               <TableCell sx={{ color: '#bbb', fontSize: '0.75em', textTransform: 'uppercase', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', width: '12%', padding: '4px 8px', textAlign: 'left', fontWeight: 'bold' }}>Sentiment</TableCell>
//               <TableCell sx={{ color: '#bbb', fontSize: '0.75em', textTransform: 'uppercase', borderBottom: '1px solid rgba(68, 68, 68, 0.5)', width: '6%', padding: '4px 8px', textAlign: 'left', fontWeight: 'bold' }}>Alert</TableCell>
//             </TableRow>
//           </TableHead>
//           <TableBody>
//             {stocks.map((stock, index) => (
